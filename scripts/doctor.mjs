...
const required = [
  ...
  path.join(root, "lib", "skill-groups.mjs"),
  path.join(root, "lib", "skill-organization.mjs"),
  path.join(root, "lib", "skill-details.mjs"),
  path.join(root, "lib", "skill-provenance.mjs"),
