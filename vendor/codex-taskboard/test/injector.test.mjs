...
test("the managed Codex launch permits only local-network subframe compatibility", () => {
  assert.match(source, /--enable-features=LocalNetworkAccessForSubframeNavigationsWarningOnly/);
  assert.doesNotMatch(source, /--disable-features=LocalNetworkAccessChecks/);
});
